...
modalAdd.addEventListener("click", () => {
  ...
  const num = document.querySelector("#pages");
  console.log(num.validity.patternMismatch, num.validity.valueMissing)

  if (name.validity.valueMissing) {
    name.setCustomValidity("Please enter a book name!");
    name.reportValidity();
  } else if (auth.validity.valueMissing) {
    auth.setCustomValidity("Please enter the author's name!");
    auth.reportValidity();
  } else if (num.validity.patternMismatch || num.validity.valueMissing) {
    num.setCustomValidity("Enter in number of pages!");
    num.reportValidity();
  } else {
